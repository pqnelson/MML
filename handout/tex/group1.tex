...
\begin{definition}
We define a \define{Group} to be a nonempty Group-like associative magma.
\end{definition}
...
\begin{definition}\index{$\inverseop{G}$}\index{Group!Inverse operator}
Let $G$ be a Group.
...
\begin{definition}\index{$\power_{G}$}\index{Group!Power of element}
